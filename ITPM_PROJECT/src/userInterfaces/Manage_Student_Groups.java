...
public class Manage_Student_Groups implements ActionListener {
	...
	private void initialize() {
		...
		tableModel = new DefaultTableModel(new String[]{"id","Academic Year|Semester", "Programme", "Group No","sno","gid","sid"}, 0);
...
//		 } 
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == generateIDsBtn) {
			...
			sg.updateStudentGroup(Integer.parseInt(selectedID), yearAndSem, programme, grNo, subGrNo, gID, subGID);
			...
			Student_Group sg = new Student_Group();
			sg.deleteStudentGroup(Integer.parseInt(selectedID));
			DefaultTableModel model = (DefaultTableModel)table.getModel();
            model.setRowCount(0);
            studentGroupTable();
